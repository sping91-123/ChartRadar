...
| 우선순위 | 상태 | 작업 | 방 | 인텔리전스 | 목표 |
| --- | --- | --- | --- | --- | --- |
| P1 | TODO | 신규 실업수당 청구 결과 확인중 문제 | 뉴스 / 매크로 레이더 | 높음 | Jobless Claims가 발표 후에도 결과 확인중으로 남지 않게 수정 |
| P2 | TODO | 글로벌 일정 뉴스 압력 명칭/한글화 | 글로벌 레이더 `/global` | 중간 | 일정 뉴스 압력 표현을 자연스럽게 정리하고 글로벌 뉴스 제목을 한국어 우선 표시 |
