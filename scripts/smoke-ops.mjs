...
expectIncludes(macroCalendar, "BLS_PUBLIC_API_URL", "매크로 BLS 무료 공식 API 연결", "src/lib/macroCalendar.ts");
...
expectIncludes(radarNewsPanel, "briefing=0", "무료 한도 초과 시 뉴스 제목 preview", "src/components/RadarNewsPanel.tsx");
...
expectIncludes(healthRoute, "hasFreeOfficialMacroProvider", "헬스체크 무료 공식 매크로 제공자", "src/app/api/health/route.ts");
