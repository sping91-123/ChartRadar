...
export interface StockSymbolInfo {
  symbol: string;
  name: string;
  group: "futures" | "index_etf" | "macro_proxy" | "sector_etf" | "mega_cap" | "ai_chip" | "growth" | "finance" | "commodity";
}
...
export const stockSymbols: StockSymbolInfo[] = [
  ...
  { symbol: "IEF", name: "7-10Y Treasury ETF", group: "macro_proxy" },
  { symbol: "SHY", name: "1-3Y Treasury ETF", group: "macro_proxy" },
  { symbol: "HYG", name: "High Yield Bond ETF", group: "macro_proxy" },
  { symbol: "LQD", name: "Investment Grade Bond ETF", group: "macro_proxy" },
  { symbol: "UUP", name: "US Dollar ETF", group: "macro_proxy" },
  { symbol: "VIXY", name: "VIX Futures ETF", group: "macro_proxy" },
  ...
  { symbol: "XLK", name: "Technology ETF", group: "sector_etf" },
  { symbol: "XLY", name: "Consumer Discretionary ETF", group: "sector_etf" },
  { symbol: "XLP", name: "Consumer Staples ETF", group: "sector_etf" },
  { symbol: "XLV", name: "Healthcare ETF", group: "sector_etf" },
  { symbol: "XLI", name: "Industrials ETF", group: "sector_etf" },
  { symbol: "XLU", name: "Utilities ETF", group: "sector_etf" },
  { symbol: "XLC", name: "Communication Services ETF", group: "sector_etf" },
  ...
  { symbol: "XLF", name: "Financials ETF", group: "sector_etf" },
  { symbol: "XLE", name: "Energy ETF", group: "sector_etf" },
