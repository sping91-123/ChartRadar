...
const menuLinks = [
  ...
  { href: "mailto:contact@staronlabs.com", label: "문의", description: "서비스 제휴와 일반 문의는 contact@staronlabs.com으로 보냅니다." },
  { href: "mailto:support@staronlabs.com", label: "고객지원", description: "계정, 결제, 앱 이용 지원은 support@staronlabs.com으로 보냅니다." },
