...
const sections = [
  ...
  },
  {
    title: "4. 유료 구독과 권한",
    body:
      "Chart Radar Pro는 시장별 월간 또는 연간 구독 방식으로 제공될 수 있습니다. 앱에서 결제한 구독은 Google Play 정책을 따르며, 웹 결제는 해당 결제 대행사의 정책을 따릅니다. 결제 상태가 정상적으로 확인된 계정에만 Pro 기능이 제공됩니다."
  },
  {
    title: "5. 금지 행위",
    body:
  ...
  },
  {
    title: "6. 데이터와 면책",
    body:
      "시세와 지표 데이터는 외부 데이터 제공처, 네트워크 상태, 브라우저 환경, API 제한의 영향을 받을 수 있습니다. 데이터 지연, 오류, 중단 또는 사용자의 매매 손실에 대해 서비스 운영자는 법령상 허용되는 범위 내에서 책임을 지지 않습니다."
  },
  {
    title: "7. 계정 삭제",
    body:
