...
const sections = [
  ...
  },
  {
    ...
    items: [
      "서비스 개선과 베타 활성화 측정을 위해 Home 스냅샷 조회, 선물 상세 이동, 조건 감시 생성·실패·충족, 알림 진입, 복기 저장, paywall 조회와 구매 단계 같은 제한된 제품 이용 이벤트를 기록할 수 있습니다.",
      ...
      "계정 삭제가 완료되면 사용자와 연결된 조건 감시, 제품 이벤트, 복기 연결 정보도 함께 삭제합니다. 사용자 정보가 없는 전역 판단 스냅샷과 품질 결과는 유지될 수 있습니다."
    ]
  }
];
