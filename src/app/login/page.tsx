...
export default function LoginPage() {
  ...
  const finishLogin = useCallback(async (response: GoogleCredentialResponse) => {
    ...
    try {
      ...
      const returnTo = safeReturnTo(window.sessionStorage.getItem(authReturnToStorageKey));
  ...
  useEffect(() => {
    ...
    window.sessionStorage.setItem(authReturnToStorageKey, readReturnTo());
        ...
        <section className="enterprise-panel p-5">
          ...
          <div className="mt-6 grid gap-3">
            <div
              ...
              className={configured ? "min-h-11 w-full overflow-hidden rounded-xl" : "hidden"}
            />
