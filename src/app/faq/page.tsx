...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Basic은 오늘 결론, 가장 큰 위험과 첫 판단 기준까지 보여줍니다. Pro는 추가 강화·무효화 기준, 세부 수치, 알림과 당시 판단 기록을 더 깊게 확인하는 구조입니다."
  },
  {
    icon: Bell,
    question: "알림과 판단 기록은 어떻게 쓰나요?",
    answer:
      "알림은 선택한 가격 조건의 변화를 확인하는 데 쓰고, 판단 기록은 당시 근거와 결과를 남겨 다음에 다시 볼 조건을 정리하는 데 사용합니다."
  },
  {
    icon: CreditCard,
