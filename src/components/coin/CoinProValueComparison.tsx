    ...
    <section aria-labelledby="coin-pro-difference" className="border-y border-ui-line py-3">
      ...
      <table className="mt-3 w-full table-fixed text-left text-xs leading-5 text-ui-muted">
        ...
        <tbody>
          ...
          <tr className="border-b border-ui-line/50"><th scope="row" className="py-2 pr-2 font-medium">내 상황별 조건 감시</th><td className="py-2">공개 조건 1개</td><td className="py-2 font-bold text-ui-text">확인·무효화 조건<br />최대 20개</td></tr>
          <tr className="border-b border-ui-line/50"><th scope="row" className="py-2 pr-2 font-medium">저장 당시와 현재 비교</th><td className="py-2">내 감시에서 확인</td><td className="py-2">BTC·ETH 여러 조건을 함께 추적</td></tr>
          <tr className="border-b border-ui-line/50"><th scope="row" className="py-2 pr-2 font-medium">내가 정한 확인 가격</th><td className="py-2">분석의 공개 조건</td><td className="py-2 text-ui-text">가격 직접 입력<br />15분봉 마감 확인</td></tr>
