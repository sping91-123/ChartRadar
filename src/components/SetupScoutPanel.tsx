  ...
  return (
    <article className="border-t border-ui-line py-4 [word-break:keep-all] first:border-t-0">
      ...
      <div className="mt-3 grid gap-3 border-y border-white/10 py-3 sm:grid-cols-2">
        ...
        <div>
          <p className="text-[11px] font-bold text-slate-500">다음 판단 기준</p>
    ...
    >
      ...
      {isAltFilterMode && !shouldShowProDetails ? (
        <div className="mt-3 border-t border-white/10 pt-3">
          ...
          Basic에서는 방향 요약과 첫 판단 기준을 제공합니다. 추가 조건, 해석을 다시 볼 기준과 세부 위험은 Pro에서 확인할 수 있습니다.
          </p>
        </div>
      ) : null}
  ...
  return (
    <section className="border-y border-ui-line py-4 sm:py-5">
      ...
      <p className="mt-3 text-[11px] leading-5 text-slate-500">
        {excludeMajor
          ? "레이더 결과는 5분 단위로 갱신됩니다. Basic은 방향 요약과 첫 판단 기준을 제공하고, 추가 조건·세부 위험은 Coin Pro에서 확인할 수 있습니다."
